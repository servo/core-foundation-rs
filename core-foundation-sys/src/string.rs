...
use base::{Boolean, CFOptionFlags, CFIndex, CFAllocatorRef, ConstStr255Param, CFRange, CFTypeID, SInt32, UInt32, UInt8, UniChar, CFComparisonResult, StringPtr, ConstStringPtr};
...
pub struct CFStringInlineBuffer {
    ...
    directUniCharBuffer: *const UniChar,
    directCStringBuffer: *const c_char,
...
/* todo: The source code of the following functions is right in CFString.h,
    we need to rewrite them in Rust.
