...
pub impl<T:Copy + AbstractCFTypeRef, E1, E2> CFWrapper<T,E1,E2> {
    ...
    fn wrap_owned(some_ref: T) -> CFWrapper<T,E1,E2> {
    ...
    fn clone(wrapper: &CFWrapper<T,E1,E2>) -> CFWrapper<T,E1,E2> {
