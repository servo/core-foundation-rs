...
extern {
    ...
    pub fn CFFileSecurityCreateCopy(allocator: CFAllocatorRef, fileSec: CFFileSecurityRef) -> CFFileSecurityRef;
    pub fn CFFileSecurityCopyOwnerUUID(fileSec: CFFileSecurityRef, ownerUUID: *mut CFUUIDRef) -> Boolean;
    pub fn CFFileSecuritySetOwnerUUID(fileSec: CFFileSecurityRef, ownerUUID: CFUUIDRef) -> Boolean;
    pub fn CFFileSecurityCopyGroupUUID(fileSec: CFFileSecurityRef, groupUUID: *mut CFUUIDRef) -> Boolean;
    ...
    pub fn CFFileSecurityClearProperties(fileSec: CFFileSecurityRef, clearPropertyMask: CFFileSecurityClearOptions) -> Boolean;
}
