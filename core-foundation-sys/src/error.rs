...
extern "C" {
    ...
    //pub fn CFErrorCreateWithUserInfoKeysAndValues(allocator: CFAllocatorRef, domain: CFErrorDomain, code: CFIndex, const void *const *userInfoKeys, const void *const *userInfoValues, numUserInfoValues: CFIndex) -> CFErrorRef;
